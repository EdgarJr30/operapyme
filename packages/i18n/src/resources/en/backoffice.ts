const backofficeEn = {
  ...
  crm: {
    ...
    customerForm: {
      ...
      ncfTypeLabel: "Default NCF type",
      ncfTypePlaceholder: "Select NCF type",
      ncfTypeEmpty: "No NCF type",
      ncfTypeHint:
        "The customer's NCF type will be used as the default when creating invoices.",
      sourceLabel: "Source",
      statusLabel: "Status",
      notesLabel: "Comments",
      notesPlaceholder:
  ...
  commercial: {
    ...
    invoices: {
      ...
      ncfTypeLabel: "NCF type",
      ncfTypePlaceholder: "Select NCF type",
      ncfTypeEmpty: "No NCF type",
      ncfLabel: "NCF",
      ncfPlaceholder: "B0100000001",
      ncfHint: "Fiscal voucher number (optional, for reference only).",
      validation: {
        ncfMax: "NCF cannot exceed 19 characters."
      },
      attachmentTitle: "Attachment",
      attachmentLabel: "Invoice attachment",
      attachmentHint:
        "Attach a historical support document. Maximum 1 file per invoice.",
      attachmentUploadAction: "Upload attachment",
      attachmentReplaceAction: "Replace attachment",
      attachmentRemoveAction: "Remove attachment",
      attachmentOpenAction: "Open attachment",
      attachmentEmpty: "No attachment added.",
      attachmentUploadError: "Could not upload the file. {message}",
      attachmentDeleteError: "Could not delete the file. {message}",
  ...
  settings: {
    ...
    company: {
      ...
      bankAccountsSectionLabel: "Bank accounts",
      addBankAccountButton: "Add bank",
      removeBankAccountButton: "Remove",
      bankLabel: "Bank",
      bankPlaceholder: "Banco Popular Dominicano",
      bankAccountLabel: "Account number",
      bankAccountPlaceholder: "001234567890",
      websiteLabel: "Internet address",
      websitePlaceholder: "www.operapyme.com",
      emailLabel: "Email address",
      emailPlaceholder: "hello@operapyme.com",
      ...
      validation: {
        ...
        websiteInvalid:
          "Use a valid internet address, for example operapyme.com or https://operapyme.com.",
        emailInvalid: "Use a valid company email address.",
        ...
        secondaryPhoneInvalid:
          "Use a valid secondary phone number with digits and common symbols like +, spaces, or dashes.",
        rncInvalid:
