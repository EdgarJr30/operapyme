...
- `settings` de empresa ahora tambien guarda `Banco` y `Cuenta bancaria` por tenant, y esos datos viajan a las cotizaciones y facturas documentales impresas en PDF
