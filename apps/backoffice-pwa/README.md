...
- `/auth` usa un layout split editorial con CTA separados para acceso existente y primer ingreso; el formulario de correo se revela despues de elegir el camino
