  ...
  it("creates quotes through the database RPC and fetches the persisted record", async () => {
    const quoteFetchQuery = createThenableBuilder({
      data: {
        ...
        title: "Propuesta Northline",
        currency_code: "USD",
        discount_application_mode: "before_tax",
        subtotal: "150.00",
    ...
    expect(supabaseMocks.rpc).toHaveBeenCalledWith("create_quote", {
      ...
      target_discount_application_mode: "before_tax",
  ...
  it("sends fast lead quotes without linked customer or lead ids", async () => {
    const quoteFetchQuery = createThenableBuilder({
      data: {
        ...
        currency_code: "USD",
        discount_application_mode: "after_tax",
        subtotal: "950.00",
        discount_total: "0.00",
        tax_total: "0.00",
        grand_total: "950.00",
    ...
    expect(supabaseMocks.rpc).toHaveBeenCalledWith("create_quote", {
      ...
      target_discount_application_mode: "after_tax",
