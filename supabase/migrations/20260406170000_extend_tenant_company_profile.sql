...
drop function if exists public.update_tenant_branding_settings(uuid, text, text, jsonb);
...
grant execute on function public.update_tenant_branding_settings(uuid, text, text, jsonb, text, text, text, text, text, text, text, text) to authenticated;
